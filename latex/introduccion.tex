...
%
%  Notas:
%  - Las citas [1]–[12] están en \begin{thebibliography} al final;
...
% ---------------------------------------------------------------------
\author{\IEEEauthorblockN{Integrante 1 [COMPLETAR]}
\IEEEauthorblockA{\textit{Ingenier\'ia de Sistemas} \\
\textit{Universidad del Norte}\\
Barranquilla, Colombia \\
correo@uninorte.edu.co}
\and
\IEEEauthorblockN{Integrante 2 [COMPLETAR]}
\IEEEauthorblockA{\textit{Ingenier\'ia de Sistemas} \\
\textit{Universidad del Norte}\\
Barranquilla, Colombia \\
correo@uninorte.edu.co}
\and
\IEEEauthorblockN{Director(a) [COMPLETAR]}
\IEEEauthorblockA{\textit{Ingenier\'ia de Sistemas} \\
\textit{Universidad del Norte}\\
Barranquilla, Colombia \\
correo@uninorte.edu.co}
...
partituras completas de forma autom\'atica \cite{rebelo2012}\cite{calvo2018}.
...
el reconocimiento \cite{mlsp2025}.
...
original; y un ciclo de aprendizaje activo que aprovecha las correcciones
...
Computer Vision}, 2026. % VERIFICAR autores — ficha DL-009
...
Springer volume, 2026. % ficha HITL-005
...
Workshop (MLSP)}, 2025. % VERIFICAR autores — ficha AL-003
...
ACM, 2024. % VERIFICAR autores — ficha DS-005
